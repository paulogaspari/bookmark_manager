...
class Emailer
	...
	#   '@api.mailgun.net/v2/bookmarkmanager.mailgun.org/messages',
	#   :from => 'NoReply Bookmarkmanager <noreply@bookmarkmanager.mailgun.org>',
	#   :to => user.email,
	#   :subject => 'Thank you for registering with Linkly.io',
	#   :text => 'Hello #{user.firstname}! Thank you for registering with us'
	# end
...
def send_welcome_message(user)
  data = Multimap.new
  data[:from] = 'NoReply Bookmarkmanager <noreply@bookmarkmanager.mailgun.org>'
  data[:to] = user.email
  data[:subject] = 'Thank you for registering with Linkly.io'
  data[:html] = "
...
<tr>
	...
	<tr>
		<td>
			...
			<img border='0' src='images/spacer.gif' width='1' height='25'><br>
  ...
  RestClient.post 'https://api:key-2-rcikfklser8dpmjuscjy9taad59a57'\
  '@api.mailgun.net/v2/bookmarkmanager.mailgun.org/messages', data
